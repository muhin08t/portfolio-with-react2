  ...
  return (
    <div className="py-[130px] px-[230px] bg-[rgba(255,248,243,255)]">
      <footer className="flex justify-center gap-[50px]">
        <div className="w-1/2">
        <h3 className="text-black text-[35px] text-center">Lets Connect</h3>
            <p className="text-[#757575] text-center text-lg">Please fill out the form on this section to contact with me or call between
        ...
        <div className="w-1/2">
        <h3 className="text-black text-[35px] text-center">Let's Message Me</h3>
        <form action="">
        ...
        <button className="btn btn-warning text-white w-[120px] ml-10">Submit</button></form>
        </div>
      </footer>
    </div>
  );
